                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <?php echo form_open_multipart('admin/nurses/savenurse/','id="myform" onSubmit="return validate();"'); ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <input type="submit" name="savenurse" value="Save Nurse" class="btn btn-success">
                                        </div>
                                    </div>
                                <?php echo form_close(); ?>
                            </div>
