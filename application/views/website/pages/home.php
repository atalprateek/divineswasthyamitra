      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="col-xs-12 sliderimg paddZero">
            <a href="#"><img src="<?= file_url('assets/images/banner_3.jpg'); ?>"></a>
          </div>
        </div>
        <!-- each slide -->
        <!--<div class="swiper-slide">
          <div class="col-xs-12 sliderimg paddZero">
            <a href="#"><img src="<?= file_url('assets/images/blog-9.jpg'); ?>"></a>
          </div>
        </div>
        <!-- each slide --
        <div class="swiper-slide">
          <div class="col-xs-12 sliderimg paddZero">
            <a href="#"><img src="<?= file_url('assets/images/clinic-6.jpg'); ?>"></a>
          </div>
        </div>-->
      </div>            
      <!-- Add Pagination -->
