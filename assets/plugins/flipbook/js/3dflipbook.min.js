!(function (modules) {
        ...
        var BaseMathUtils = (function () {
            ...
            return (
                ...
                (BaseMathUtils.isInsidePoly = function (ps, p) {
                    ...
                    for (; !done; ) {
                        (done = !0), (ct = 0);
                        for (var np = { x: p.x + Math.random() - 0.5, y: p.y + Math.random() - 0.5 }, rn = { x: np.x - p.x, y: np.y - p.y }, a1 = [rn.y, -rn.x], b1 = p.x * rn.y - p.y * rn.x, _i4 = 0; _i4 < ps.length; ++_i4) {
                            var p0 = ps[_i4],
                ...
                function SheetBlock(visual, p, first, last) {
                    ...
                    if (
                        ...
                        (this.p.sideFaces = [
                            ...
                            { first: _sheetBlock2.default.faces[0], last: _sheetBlock2.default.faces[1] },
                        ]),
                    ...
                    (this.corner = { use: !0, height: 0, maxDistance: 0, points: [], OZ: new _libs.THREE.Vector3(0, 0, 1), axis: new _libs.THREE.Vector3() }),
                ...
                return (
                    ...
                    (SheetBlock.prototype.getTopWorldPosition = function (v) {
                        ...
                        for (var _iterator3 = vs, _isArray3 = Array.isArray(_iterator3), _i5 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator](); ; ) {
                            ...
                            var vi = _ref3;
                            (v.x += 0.25 * vi.x), (v.y += 0.25 * vi.y), (v.z += 0.25 * vi.z);
                        }
                        return this.three.localToWorld(v), v;
                    }),
                    (SheetBlock.prototype.getInterpolationPoints = function (inds, mod) {
                        for (var ps = { x: [], y: [] }, K = this.getProps().wave, _iterator4 = inds, _isArray4 = Array.isArray(_iterator4), _i6 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator](); ; ) {
                            var _ref4;
                            if (_isArray4) {
                    ...
                    (SheetBlock.prototype.set = function (angle) {
                        ...
                        var closedAngle = void 0,
                            binderTurn = void 0;
                        "object" === ("undefined" == typeof angle ? "undefined" : _typeof(angle))
                            ? ((this.angle = angle.openedAngle), (closedAngle = angle.closedAngle), (binderTurn = angle.binderTurn > PI / 2 ? PI - angle.binderTurn : angle.binderTurn))
                            : (this.angle = angle),
                            (this.corner.height = height),
                            (this.p.first === first && this.p.last === last) ||
                                (this.sideTexture.repeat.set(0, last - first),
                                (this.sideTexture.needsUpdate = !0),
                                this.p.first !== first && this.p.setTexture(this.materials[0], 2 * first),
                                this.p.last !== last && this.p.setTexture(this.materials[1], 2 * last - 1)),
                            (this.p.first = first),
                            (this.p.last = last);
                        var points = void 0,
                            props = this.getProps();
                        if ("closed" === this.state) points = this.getInterpolationPoints(this.closedInterpolationIndeces, this.closedInterpolationIndeces);
                            ...
                            if (void 0 !== closedAngle && Math.abs(closedAngle - PI / 2) > 0.01) {
                    ...
                    (SheetBlock.prototype.setPoints = function (left, right, offset) {
                        for (var _this2 = this, p = this.getProps(), i = 0, ys = [right, left], y = 0; y < _sheetBlock2.default.resY; ++y)
                            for (var z = 0; z < _sheetBlock2.default.resZ; ++z)
                                for (var x = 0; x < _sheetBlock2.default.resX; ++x) this.geometry.vertices[i++].set(ys[y].x[x] * p.width + offset, ys[y].y[x] * p.width, (z * p.height) / (_sheetBlock2.default.resZ - 1) - 0.5 * p.height);
                    ...
                    (SheetBlock.prototype.loadPoints = function () {
                        for (var x = [], y = [], _arr = [0, 0.2877, 0.6347, 0.8174, 1], _i11 = 0; _i11 < _arr.length; _i11++) {
                            var r = _arr[_i11];
                            x.push(r * Math.cos((0.9 * Math.PI) / 4)), y.push(r * Math.sin((0.9 * Math.PI) / 4));
                        }
                        var openedInterpolationIndeces = [
                            ...
                            interpolationPoints = [
                                {
                                    x: [[0, 0.2877, 0.6347, 0.8174, 1], [0, 0.286, 0.632, 0.815, 0.997], [0, 0.279, 0.623, 0.806, 0.988], [0, 0.126, 0.411, 0.593, 0.774], [0, 0, 0, 0, 0], x],
                                    y: [[0, 0, 0, 0, 0], [0, 0.03, 0.01, 0.002, 0], [0, 0.06, 0.017, 0.004, 0], [0, 0.259, 0.44, 0.446, 0.429], [0, 0.2877, 0.6347, 0.8174, 1], y],
                                },
                                {
                                    x: [
                        ...
                        return { interpolationPoints: interpolationPoints, openedInterpolationIndeces: openedInterpolationIndeces, closedInterpolationIndeces: closedInterpolationIndeces, flatInterpolationIndeces: flatInterpolationIndeces };
                    }),
                    SheetBlock
                );
            })();
    ...
    function (module, exports) {
        ...
        function props() {
            return {
                ...
                preloadPages: 5,
                rtl: !1,
                sheet: { startVelocity: 0.9, cornerDeviation: 0.25, flexibility: 10, flexibleCorner: 0.5, bending: 11, wave: 0.5, shape: 0, widthTexels: 1050, heightTexels: 1485, color: 16777215 },
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _libs = __webpack_require__(0),
            _Utils = __webpack_require__(4),
            _Utils2 = _interopRequireDefault(_Utils);
        (_libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : { pdfJsWorker: "../assets/plugins/flipbook/js/pdf.worker.js", pdfJsCMapUrl: "cmaps/" }).pdfJsWorker),
            (_libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE ? PDFJS_LOCALE : { pdfJsWorker: "../assets/plugins/flipbook/js/pdf.worker.js", pdfJsCMapUrl: "cmaps/" }).pdfJsCMapUrl),
        ...
        var Pdf = (function () {
            function Pdf(src, loadingProgress) {
                ...
                _classCallCheck(this, Pdf),
                    ...
                    _libs.PDFJS.getDocument({ url: this.src, rangeChunkSize: 524288 }, null, null, function (data) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        var _BaseMathUtils = __webpack_require__(2),
            ...
            ThreeUtils = (function () {
                ...
                return (
                    (ThreeUtils.vertices2UVs = function (vertices, indeces, first, last, converClb) {
                    ...
                    (ThreeUtils.findInternalVertices = function (geometry, ps, first, last) {
                        for (var res = {}, i = first; i < last; ++i)
                            for (var tri = geometry.faceVertexUvs[0][i], f = geometry.faces[i], vs = [f.a, f.b, f.c], j = 0; j < tri.length; ++j)
                                void 0 === res[vs[j]] && _BaseMathUtils2.default.isInsidePoly(ps, tri[j]) && (res[vs[j]] = { p: tri[j], i: vs[j], n: f.vertexNormals[j] });
                        ...
                        _Detector2.default.webgl
                            ? ((scene.loadingCtrl = new _LoadingController2.default(scene.view, !0, function (progress) {
                              ...
                              (scene.bookBuilder = function (props, sheets, pageCallback) {
                                  (props.cssLayerProps = _extends({}, props.cssLayerProps, { scene: scene })),
                              ...
                              options.pdf
                                  ? ((scene.propsBuilder = new _PdfBookPropsBuilder2.default(options.pdf, scene.bookBuilder)), scene.propsBuilder.pdf.setLoadingProgressClb(scene.loadingCtrl.setProgress.bind(scene.loadingCtrl)))
            ...
            AutoNavigator = (function () {
                function AutoNavigator(context, bookCtrl) {
                    ...
                    _classCallCheck(this, AutoNavigator),
                        (props = _extends({}, props, { urlParam: props.urlParam || "fb3d-page", navigates: void 0 === props.navigates ? 1 : props.navigates })),
                        (this.props = props),
                        (this.context = context),
            ...
            Binder = (function () {
                function Binder(visual, p) {
                    ...
                    _classCallCheck(this, Binder),
                        (this.visual = visual),
                        (this.p = _extends({}, p, { backSize: 2 * p.cover.depth + p.sheets * p.page.depth })),
                ...
                return (
                    ...
                    (Binder.prototype.joinLeftCover = function (cover) {
                        cover.three.position.set(0, -0.5 * this.p.cover.depth, 0), this.leftPivot.add(cover.three);
                    }),
                    ...
                    (Binder.prototype.joinRightCover = function (cover) {
                        cover.three.position.set(0, -0.5 * this.p.cover.depth, 0), this.rightPivot.add(cover.three);
                    }),
            ...
            Book = (function (_THREE$EventDispatche) {
                function Book(visual, sheets, pageCallback, props) {
                    ...
                    return (
                        ...
                        (_this.p = _extends({}, Book.prepareProps(props), { sheets: sheets, pageCallback: pageCallback, zoom: 1, singlePage: !1, autoResolution: { enable: !1, k: 1.5 } })),
                        ...
                        (_this.sheetBlocks = []),
                        sheets > 0 && _this.addSheetBlock(0, new _SheetBlock2.default(visual, _extends({}, _this.p, { setTexture: _this.setPageTexture.bind(_this) }), 0, sheets, 0, "closed")),
                        ...
                        (_this.tmp = { boxs: [new _libs.THREE.Box3(), new _libs.THREE.Box3()] }),
                ...
                return (
                    ...
                    (Book.prototype.setZoom = function (zoom, singlePage) {
                        (Math.abs(this.p.zoom - zoom) > 0.001 || singlePage !== this.p.singlePage) && ((this.p.zoom = zoom), (this.p.singlePage = singlePage), this.pageManager.refreshZoom());
                    }),
                    ...
                    (Book.prototype.getLeftFlipping = function () {
                        var block = void 0,
                            ...
                            PI = Math.PI;
                        return (
                            this.angle === PI ? (block = this.rightCover) : left && "closed" === left.state && left.angle > PI / 2 ? (block = left) : (this.angle !== PI / 2 && this.angle !== (3 * PI) / 2) || (block = this.leftCover), block
                        );
                    }),
                    (Book.prototype.getRightFlipping = function () {
                        var block = void 0,
                            ...
                            PI = Math.PI;
                        return (
                            0 === this.angle ? (block = this.leftCover) : right && "closed" === right.state && right.angle <= PI / 2 ? (block = right) : (this.angle !== PI / 2 && this.angle !== (3 * PI) / 2) || (block = this.rightCover),
                            block
                        );
                    }),
                                    ...
                                    _this2.angle === PI
                                        ...
                                        ? ((block = size < left.getSize() ? _this2.splitSheetBlock(0, left.getSize() - size)[1] : left),
                                          (res = _this2.connectPhysics(
                                              ...
                                              Book.finishAnimationClb.bind({ book: _this2, block: block }),
                                              progressClb
                                          )))
                                        : (_this2.angle !== PI / 2 && _this2.angle !== (3 * PI) / 2) ||
                                          (res = _this2.connectPhysics(
                                    ...
                                    0 === _this3.angle
                                        ...
                                        ? ((block = size < right.getSize() ? _this3.splitSheetBlock(_this3.sheetBlocks.length - 1, size)[0] : right),
                                          (res = _this3.connectPhysics(
                                              ...
                                              Book.finishAnimationClb.bind({ book: _this3, block: block }),
                                              progressClb
                                          )))
                                        : (_this3.angle !== PI / 2 && _this3.angle !== (3 * PI) / 2) ||
                                          (res = _this3.connectPhysics(
                    ...
                    (Book.prototype.xSegment = function () {
                        ...
                        return (
                            this.leftCover.physicId
                                ? (boxs[0].setFromObject(this.rightCover.three), (res.min = -(res.max = boxs[0].max.x)))
                                : this.rightCover.physicId
                                ? (boxs[0].setFromObject(this.leftCover.three), (res.max = -(res.min = boxs[0].min.x)))
                                : (boxs[0].setFromObject(this.leftCover.three), boxs[1].setFromObject(this.rightCover.three), boxs[0].union(boxs[1]), (res.min = boxs[0].min.x), (res.max = boxs[0].max.x)),
                            res
                        );
                    }),
                            ...
                            !(function () {
                                ...
                                if ("mouseover" === e.type)
                                    _this4.hoverInfo && void 0 !== _this4.hoverInfo.pendings
                                        ...
                                        : (_this4.hoverInfo && (console.warn("Wrong state: element is already hover"), _this4.hoverInfo.n !== n && _this4.clearHoverInfo()),
                                          _this4.hoverInfo ||
                                              _this4.dragInfo ||
                                              !(function () {
                                                  ...
                                                  if (n > 1 && n < 2 * (_this4.p.sheets + 1) && hover.physicId && (hover.angle < hoverAngle || hover.angle > Math.PI - hoverAngle)) res = Promise.resolve(hover);
                                                      ...
                                                      (!nextBlock || !nextBlock.physicId || (nextBlock.angle > hoverAngle && nextBlock.angle < Math.PI - hoverAngle)) &&
                                ...
                                else if ("mousedown" === e.type) _this4.cornerClickData = { x: e.pageX, y: e.pageY };
                    ...
                    (Book.prototype.set = function (angle) {
                        ...
                        var PI = Math.PI;
                        if (angle < PI / 4)
                            this.binder.set(0), this.binder.setLeft(-PI / 2 + 2 * angle), this.leftCover.set(PI / 2, "opened", height), this.setSheetBlocks(0, "closed"), this.binder.setRight(0), this.rightCover.set(0, "closed", 0);
                    ...
                    (Book.calcProps = function (props) {
                        var p = _extends({}, props, {
                            ...
                            cover = _extends({}, sheet, p.cover, { depth: scale * p.cover.depth, width: width, height: height, padding: scale * p.cover.padding }),
                            page = _extends({}, sheet, p.page, { depth: scale * p.page.depth, width: cover.width - cover.padding, height: cover.height - 2 * cover.padding }),
                            marker = { use: !1, color: 16711680, size: 0.001 * scale };
                        return (
                            cover.color === sheet.color || p.cover.sideTexture || (cover.sideTexture = Book.createSideTexture(cover.color)),
                            page.color === sheet.color || p.page.sideTexture || (page.sideTexture = Book.createSideTexture(page.color)),
                            _extends({}, p, { scale: scale, height: height, width: width, flipProgressClb: flipProgressClb, cover: cover, page: page, marker: marker })
                        );
                    }),
                    Book
                );
            ...
            BookController = (function (_Controller) {
                function BookController(book, view, props) {
                    ...
                    return (
                        ...
                        (_this.bookWatcher = new _Object3DWatcher2.default(_this.visual, function () {
                            return (
                                _this.state.singlePage
                                    ...
                                    : (_this.boxs[0].setFromObject(book.leftCover.three), _this.boxs[1].setFromObject(book.rightCover.three), _this.boxs[0].union(_this.boxs[1])),
                                _this.boxs[0]
                            );
                        })),
                        ...
                        (_this.binds = { onScreenModeChanged: _this.onScreenModeChanged.bind(_this), stats: _this.Stats.update.bind(_this.Stats), onUpdateView: _this.updateView.bind(_this) }),
                ...
                return (
                    ...
                    (BookController.prototype.cmdZoomIn = function () {
                        this.state.smartPan
                            ? ((this.bookWatcher.scale = Math.min(this.p.scale.max, this.bookWatcher.scale + this.p.scale.delta)), this.setBookZoom(this.bookWatcher.scale))
                            : this.orbit.zoomIn((6.6 * this.p.scale.delta) / 0.32),
                            this.updateView();
                    }),
                    (BookController.prototype.cmdZoomOut = function () {
                        this.state.smartPan
                            ? ((this.bookWatcher.scale = Math.max(this.p.scale.min, this.bookWatcher.scale - this.p.scale.delta)), this.setBookZoom(this.bookWatcher.scale))
                    ...
                    (BookController.prototype.cmdSmartPan = function () {
                        (this.state.smartPan = !this.state.smartPan),
                            this.state.smartPan
                                ? ((this.orbit.minAzimuthAngle = 0), (this.orbit.maxAzimuthAngle = 0), (this.orbit.minPolarAngle = 0), (this.orbit.maxPolarAngle = Math.PI / 4), (this.bookWatcher.enabled = !0))
                                : ((this.orbit.minAzimuthAngle = -(1 / 0)), (this.orbit.maxAzimuthAngle = 1 / 0), (this.orbit.minPolarAngle = 0), (this.orbit.maxPolarAngle = Math.PI), (this.bookWatcher.enabled = !1)),
                            this.updateView();
                    }),
                    ...
                    (BookController.prototype.cmdStats = function () {
                        (this.state.stats = !this.state.stats),
                            this.state.stats
                                ? ((0, _libs.$)(this.view.getContainer()).append(this.Stats.domElement), this.visual.addRenderCallback(this.binds.stats))
                                : ((0, _libs.$)(this.view.getContainer()).find(this.Stats.domElement).remove(), this.visual.removeRenderCallback(this.binds.stats)),
                            this.updateView();
                    }),
                    ...
                    (BookController.prototype.updateViewState = function () {
                        this.viewState = {
                            ...
                            cmdDefaultZoom: { enable: this.canDefaultZoom(), visible: this.actions.cmdDefaultZoom.enabled, active: this.canDefaultZoom() && Math.abs(this.bookWatcher.scale - this.p.scale.default) < this.p.eps },
                            cmdToc: { enable: !!this.tocCtrl, visible: this.actions.cmdToc.enabled && this.tocCtrl, active: this.tocCtrl && this.tocCtrl.visible },
                            ...
                            cmdFullScreen: { enable: _FullScreen2.default.available(), visible: this.actions.cmdFullScreen.enabled, active: _FullScreen2.default.available() && _FullScreen2.default.activated() },
                            ...
                            cmdSinglePage: { enable: !0, visible: this.actions.cmdSinglePage.enabled, active: this.state.singlePage },
                            cmdSounds: { enable: !0, visible: this.actions.cmdSounds.enabled && !!this.sounds, active: !!this.sounds && this.sounds.enabled },
                            cmdStats: { enable: !0, visible: this.actions.cmdStats.enabled, active: this.state.stats },
                            cmdLightingUp: { enable: Math.abs(this.state.lighting - this.p.lighting.max) > this.p.eps, visible: this.actions.cmdLightingUp.enabled, active: !1 },
                            cmdLightingDown: { enable: Math.abs(this.state.lighting - this.p.lighting.min) > this.p.eps, visible: this.actions.cmdLightingDown.enabled, active: !1 },
                        };
                        for (
                            ...
                            var name = _ref3;
                            this.viewState[name] = { enable: flippersEnable[name], visible: this.actions[name].enabled, active: !1 };
                        }
                    }),
                                ...
                                activate: function (e, data) {
                                    if (isSwipping("touchCmdSwipe"))
                                        if ((e.preventDefault(), "start" === data.state)) {
                                            ...
                                            _this8.swipeData = { handled: !1, x0: touch.pageX, y0: touch.pageY, x: touch.pageX, y: touch.pageY };
                                        } else
                                            "move" === data.state
                                                ? _this8.swipeData.handled ||
                                                  ((_this8.swipeData = _extends({}, _this8.swipeData, { x: _this8.swipeData.x + data.dx, y: _this8.swipeData.y + data.dy })),
                                                  Math.abs(_this8.swipeData.x0 - _this8.swipeData.x) > 100 && (_this8.swipeData.x0 > _this8.swipeData.x ? _this8.cmdForward() : _this8.cmdBackward(), (_this8.swipeData.handled = !0)))
                                ...
                                ? !(function () {
                                      ...
                                      _this.useIFrame()
                                          ? ((callManually = !!_this.frame),
                                            _this.frame || (_this.frame = (0, _libs.$)('<iframe src="' + _this.pdfSrc + '" style="display: none;"></iframe>').appendTo(_this.doc.body)),
            ...
            BookView = (function (_View) {
                ...
                return (
                    ...
                    (BookView.prototype.getTemplate = function () {
                        return { html: "../assets/plugins/flipbook/templates/default-book-view.html", styles: ["../assets/plugins/flipbook/css/black-book-view.css"], links: [{ rel: "stylesheet", href: "../assets/plugins/flipbook/css/font-awesome.min.css" }], script: "../assets/plugins/flipbook/js/default-book-view.js" };
                    }),
                    BookView
                );
            })(_View3.default);
            ...
            Cover = (function (_SheetBlock) {
                ...
                return (
                    ...
                    (Cover.prototype.loadPoints = function () {
                        ...
                        return { interpolationPoints: interpolationPoints, openedInterpolationIndeces: openedInterpolationIndeces, closedInterpolationIndeces: closedInterpolationIndeces };
                    }),
                    Cover
                );
                            ...
                            Promise.resolve().then(function () {
                                if (o.texture) {
                                    ...
                                    (o.wrapper = _this3.imageFactory.build(pi, void 0 === pi.number ? n : pi.number, res.width, res.height, p.color, _this3.p.injector)),
                                        ...
                                        (o.simulate = pi.interactive ? (o.wrapper.simulate || function () {}).bind(o.wrapper) : void 0),
                                        ...
                                        (o.wrapper.onChange = function (image) {
                                            o.texture &&
                                                ...
                                                o.material && ((o.material.map = o.texture), (o.material.color = new _libs.THREE.Color(16777215)), (o.material.needsUpdate = !0)),
            ...
            PdfBookPropsBuilder = (function (_BookPropsBuilder) {
                function PdfBookPropsBuilder(src, onReady) {
                    ...
                    return (
                        ...
                        (_this.pageDescription = { type: "pdf", src: _this.pdf, interactive: !0 }),
                            ...
                            this.page < this.pages &&
                                !(function () {
                                    ...
                                    _this.find(_this.pageCallback(_this.page)).then(function (contexts) {
                                        stamp === _this.stamp &&
                                            (contexts.length && _this.results.push({ page: _this.page, contexts: contexts }), ++_this.page, _this.onPageHitsChanged && _this.onPageHitsChanged(_this.page, _this.query), _this.process());
                                    });
                                })();
                    }),
            ...
            SheetPhysics = (function () {
                function SheetPhysics() {
                    var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                        ...
                        cornerDeviation = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0.15,
                        fps = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 240;
                    _classCallCheck(this, SheetPhysics),
                        (this.p = { r: r, cornerDeviation: cornerDeviation, l: Math.PI * r, startDt: 1 / fps, gravity: gravity, margin: 0.002 * r, infM: 1e4, attempts: 16, maxIterations: 100 }),
                        (this.os = []);
                }
                return (
                    ...
                    (SheetPhysics.prototype.addObject = function (mass, angle, velocity, flexibility, cornerHeight, simulateClb, removeClb) {
                        var forceClb =
                            ...
                            no = { id: _MathUtils2.default.getUnique(), m: mass, v: velocity, l: angle * this.p.r, f: forceClb, cf: cornerForceClb, ch: cornerHeight, flbt: flexibility, simulateClb: simulateClb, removeClb: removeClb },
                    ...
                    (SheetPhysics.prototype.getParametrMap = function (name) {
                        var map = { mass: "m", velocity: "v", flexibility: "flbt", cornerHeight: "ch", simulateClb: "simulateClb", removeClb: "removeClb", forceClb: "f", cornerForceClb: "cf" };
                        return map[name];
                    }),
                    ...
                    (SheetPhysics.prototype.findAndSolveCornerCollisions = function () {
                        if (this.os.length)
                            for (var os = [_extends({}, this.os[0], { l: 0, m: this.p.infM, ch: 0 })].concat(this.os, [_extends({}, this.os[0], { l: 1.05 * this.p.l, m: this.p.infM, ch: 0 })]), i = 1; i < os.length; ++i) {
                                var a = os[i - 1],
                                    b = os[i],
                    ...
                    (SheetPhysics.prototype.findCollisions = function (os) {
                        for (var ci = { num: 0, last: 0, all: [] }, i = 1; i < os.length && ci.num < 2; ++i)
                            (os[i - 1].l > os[i].l || this.isCollision(os[i - 1], os[i])) &&
                                (os[i - 1].l > os[i].l && ++ci.num, ++ci.num, (ci.last = i), ci.all.indexOf(i - 1) === -1 && ci.all.push(i - 1), ci.all.indexOf(i) === -1 && ci.all.push(i));
                        return ci;
                    }),
                    ...
                    (SheetPhysics.prototype.integrate = function (os, dt) {
                        for (var nos = [], _iterator6 = os, _isArray6 = Array.isArray(_iterator6), _i7 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator](); ; ) {
                            ...
                            var o = _ref6,
                                vl = _MathUtils2.default.rk4(this.dy.bind({ g: this.p.gravity, r: this.p.r, m: o.m, f: o.f, cf: o.cf, ch: o.ch, flbt: o.flbt }), 0, dt, [o.v, o.l, o.ch]),
            ...
            TocController = (function (_WidgetController) {
                ...
                return (
                    ...
                    (TocController.prototype.updateView = function () {
                        var _this3 = this;
                        this.view &&
                            (this.view.setState("widTocMenu", { enable: !0, visible: !0, active: !1 }),
                            this.view.setState("widThumbnails", { enable: !0, visible: "thumbnails" === this.tab, active: !1 }),
                            this.view.setState("widSearch", { enable: !0, visible: "search" === this.tab, active: !1 }),
                            this.view.setState("widBookmarks", { enable: !0, visible: "bookmarks" === this.tab, active: !1 }),
                            this.view.setState("cmdBookmarks", { enable: !0, visible: !0, active: "bookmarks" === this.tab }),
                            this.view.setState("cmdCloseToc", { enable: !0, visible: !0, active: !1 }),
                            this.view.setState("cmdThumbnails", { enable: !0, visible: !0, active: "thumbnails" === this.tab }),
                            this.view.setState("cmdSearch", { enable: !0, visible: !0, active: "search" === this.tab }),
                            Promise.resolve().then(function () {
    ...
    function (module, exports, __webpack_require__) {
        ...
        backGeometry.rotateY(Math.PI), backGeometry.translate(0.5 * scale, 0.5 * scale, 0);
        var leftGeometry = new _libs.THREE.PlaneGeometry(scale, scale, resZ - 1, resY - 1);
        leftGeometry.rotateY(-Math.PI / 2), leftGeometry.translate(0, 0.5 * scale, 0.5 * scale);
        var rightGeometry = new _libs.THREE.PlaneGeometry(scale, scale, resZ - 1, resY - 1);
        rightGeometry.rotateY(Math.PI / 2), rightGeometry.translate(scale, 0.5 * scale, 0.5 * scale);
        var topGeometry = new _libs.THREE.PlaneGeometry(scale, scale, resX - 1, resZ - 1);
        topGeometry.rotateX(-Math.PI / 2), topGeometry.translate(0.5 * scale, scale, 0.5 * scale);
        ...
        addFaces(topGeometry.faces, function (i) {
            ...
            (exports.default = { resX: resX, resY: resY, resZ: resZ, faces: faces, geometry: geometry });
    },
    function (module, exports) {
        "use strict";
        function props() {
            return {
                ...
                scale: { default: 0.9, min: 0.9, max: 2.5, levels: 7 },
            ...
            Bookmarks = (function () {
                                    ...
                                    if (cmd.hasClass("cmd")) {
                                        ...
                                        cmd.hasClass("togle")
                                            ? ((node.minimized = !node.minimized),
                                              node.minimized
                                                  ? (li.find("ul").remove(), li.find(".togle").addClass("minimized"))
                                                  : (li.find(".togle").removeClass("minimized"), li.append((_this.renderNode(node).match(/<ul.*<\/ul>/) || [""])[0])))
                ...
                return (
                    ...
                    (Bookmarks.prototype.forEach = function (f) {
                        for (
                            var nodes = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.nodes,
                                _iterator = nodes || [],
                                _isArray = Array.isArray(_iterator),
                                _i = 0,
                                _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();
            ...
            function cloneNode(node, filter, root) {
                ...
                function cloneChildren(original, clone, filter) {
                    ...
                    return 0 === children.length
                        ...
                        : cloneChildrenInOrder(clone, util.asArray(children), filter).then(function () {
                              return clone;
                          });
                }
            ...
            function newUtil() {
                function mimes() {
                    var WOFF = "application/font-woff",
                        JPEG = "image/jpeg";
                    return { woff: WOFF, woff2: WOFF, ttf: "application/font-truetype", eot: "application/vnd.ms-fontobject", png: "image/png", jpg: JPEG, jpeg: JPEG, gif: "image/gif", tiff: "image/tiff", svg: "image/svg+xml" };
                }
            ...
            Drag = (function () {
                function Drag(wnd, doc, visualWorld) {
                    _classCallCheck(this, Drag),
                        ...
                        (this.binds = { onMouseMove: this.onMouseMove.bind(this), onMouseDown: this.onMouseDown.bind(this), onMouseUp: this.onMouseUp.bind(this) }),
                    ...
                    (Drag.prototype.onMouseMove = function (e) {
                        this.enabled &&
                            ...
                            this.selected &&
                                ...
                                this.raycaster.ray.intersectPlane(this.plane, this.intersection) && (this.onDragCallback(this.intersection) || this.onMouseUp(e))));
                    }),
            ...
            return (
                ...
                (EventsToActions.getPosition = function (touches) {
                    var x = void 0,
                        y = void 0;
                    return (
                        2 === touches.length ? ((x = touches[1].pageX - touches[0].pageX), (y = touches[1].pageY - touches[0].pageY), (y = -Math.sqrt(x * x + y * y)), (x = 0)) : ((x = touches[0].pageX), (y = touches[0].pageY)),
                        { x: x, y: y }
                    );
                }),
                ...
                (EventsToActions.prototype.mouseDown = function (e) {
                    if ((this.picked && this.mouseUpDoc(), this.enabled)) {
                        ...
                        this.fireActions(this.getActions("mousedown", e.button, flags), e),
                            (this.picked = { x: e.pageX, y: e.pageY, actions: this.getActions("mousedrag", e.button, flags) }),
                ...
                (EventsToActions.prototype.mouseMoveDoc = function (e) {
                    this.enabled &&
                        this.picked &&
                        (this.fireActions(this.picked.actions, e, { state: "move", dx: e.pageX - this.picked.x, dy: e.pageY - this.picked.y }), (this.picked = { x: e.pageX, y: e.pageY, actions: this.picked.actions }));
                }),
                ...
                (EventsToActions.prototype.touchPick = function (e, flags, touches) {
                    (this.touchPicked = _extends({}, EventsToActions.getPosition(touches), { actions: this.getActions("touchdrag", touches.length, flags), code: touches.length, flags: flags })),
                    ...
                    if (this.enabled) {
                        ...
                        if ((this.fireActions(this.getActions("touchmove", touches.length, flags), e), this.touchPicked))
                            if (this.touchPicked.code === touches.length && this.touchPicked.flags === flags) {
                                ...
                                this.fireActions(this.touchPicked.actions, e, { state: "move", dx: pos.x - this.touchPicked.x, dy: pos.y - this.touchPicked.y }), (this.touchPicked = _extends({}, this.touchPicked, pos));
        ...
        var _libs = __webpack_require__(0),
            ...
            LoadingAnimation = (function () {
                function LoadingAnimation(width, height, color) {
                    ...
                    (this.c = jC[0]), (this.p = { g: 9.8, dt: 1 / 60, color: color, updateInterval: 0.25 }), (this.ctx = this.c.getContext("2d")), (this.os = [-2, Math.PI / 2]), (this.t = this.p.updateInterval);
                }
                return (
                    ...
                    (LoadingAnimation.prototype.update = function (T) {
                        if (((this.os = this.integrate(T)), (this.t += T), this.t >= this.p.updateInterval)) {
                            ...
                            for (var i = 0, _a = a, _r = 0.2 * r; i < ps; ++i, _r *= 0.9, _a += da) {
                                ctx.beginPath(), (ctx.fillStyle = _GraphUtils2.default.color2Rgba(_GraphUtils2.default.inverseColor(this.p.color, (ps - i) / ps), (0.7 * (ps - i)) / ps));
                                var cx = x0 + r * Math.cos(_a),
                                    cy = y0 - r * Math.sin(_a),
                                    nx = x0 + r * Math.cos(_a + da),
                                    ny = y0 - r * Math.sin(_a + da);
                                (ctx.shadowOffsetX = 0.2 * (nx - cx)), (ctx.shadowOffsetY = 0.2 * (ny - cy)), ctx.arc(cx, cy, _r, 0, 2 * Math.PI, 1), ctx.fill();
                            }
            ...
            (function () {
                ...
                return (
                    ...
                    (LoadingController.prototype.updateView = function () {
                        if (this.view) {
                            this.view.setState("widLoadingProgress", { enable: !0, visible: this.showProgress, active: !1 }), this.view.setState("txtLoadingProgress", { value: this.getLoadingMsg(this.progress), visible: !0 });
                ...
                return (
                    ...
                    (Object3DWatcher.prototype.computeClientBoundBox = function () {
                        ...
                        return (
                            ...
                            (res.mid = { x: 0.5 * (res.max.x + res.min.x), y: 0.5 * (res.max.y + res.min.y) }),
                            res
                        );
                    }),
                    ...
                    (Object3DWatcher.prototype.computeCorr = function (K, min, max) {
                        var corr = 0;
                        return K < 1 ? (min > -0.5 ? (corr = -0.5 - min) : max < 0.5 && (corr = 0.5 - max)) : min < -0.5 ? (corr = -0.5 - min) : max > 0.5 && (corr = 0.5 - max), corr;
                    }),
                    ...
                    (Object3DWatcher.prototype.centerView = function (T) {
                        ...
                        var dv = this.dv;
                        if (
                            (K > 1 - this.eps ? dv.set(-box.mid.x, -box.mid.y) : dv.set(this.computeCorr(Kx, box.min.x, box.max.x), this.computeCorr(Ky, box.min.y, box.max.y)),
                            Math.sqrt(this.os.vx * this.os.vx + this.os.vy * this.os.vy) > 0.003 || dv.length() > 0.003)
                        ) {
                            var dt = 1 / 60,
                                t = 0,
                            ...
                            for (
                                os.tf = function (vx, vy, x, y) {
                                    return { x: (75 * (dv.x - x)) / Math.pow(_this.devicePixelRatio, 1), y: (75 * (dv.y - y)) / Math.pow(_this.devicePixelRatio, 1) };
                                };
                                t < T;

                            )
                                t + dt > T && (dt = T - t), (os = this.integrate(os, dt)), (t += dt);
                ...
                function Orbit(object, domElement) {
                    ...
                    function dollyIn(dollyScale) {
                        scope.object instanceof _libs.THREE.PerspectiveCamera
                            ...
                            ? ((scope.object.zoom = Math.max(scope.minZoom, Math.min(scope.maxZoom, scope.object.zoom * dollyScale))), scope.object.updateProjectionMatrix(), (zoomChanged = !0))
                        ...
                        (_this.update = (function () {
                            ...
                            return function () {
                                ...
                                return (
                                    ...
                                    (scale = 1),
                                    panOffset.set(0, 0, 0),
                                    !!(zoomChanged || lastPosition.distanceToSquared(scope.object.position) > EPS || 8 * (1 - lastQuaternion.dot(scope.object.quaternion)) > EPS) &&
                                        (scope.dispatchEvent(changeEvent), lastPosition.copy(scope.object.position), lastQuaternion.copy(scope.object.quaternion), (zoomChanged = !1), !0)
                                );
                            };
                        })()),
                            ...
                            return function (deltaX, deltaY) {
                                ...
                                if (scope.object instanceof _libs.THREE.PerspectiveCamera) {
                                    ...
                                    scope.object instanceof _libs.THREE.OrthographicCamera
                                        ...
                                        : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type-pan disabled."), (scope.enablePan = !1));
                            };
                        })()),
                        (_this.actions = { rotate: rotate, pan: pan, offsetDolly: offsetDolly, wheelDolly: wheelDolly }),
                        _this.update(),
                        _this
                    );
                }
                ...
                return (
                    ...
                    (PdfImage.prototype.calcViewport = function () {
                        ...
                        (!this.viewport || Math.abs(this.viewport.scale - scale) > 1e-4) &&
                            ...
                            "full" !== this.type && ("right" === this.type && ((this.viewport.offsetX += 0.5 * this.viewport.width), (this.viewport.transform[4] -= 0.5 * this.viewport.width)), (this.viewport.width /= 2)),
                    ...
                    (PdfImage.prototype.render = function (handler) {
                        var _this5 = this;
                        this.page
                            ? this.page.render({ canvasContext: this.pushCtx(), viewport: this.viewport }).then(function () {
            ...
            Search = (function () {
                function Search(container, pages) {
                    _classCallCheck(this, Search),
                        ...
                        (this.binds = { navigate: this.navigate.bind(this), doQuery: this.doQuery.bind(this) }),
            ...
            Thumbnails = (function () {
                function Thumbnails(context, container, thumbnailsClb, size) {
                    ...
                    _classCallCheck(this, Thumbnails),
                        ...
                        (this.size = size),
                        (this.canvas = (0, _libs.$)("<canvas>")[0]),
                        (this.imageFactory = new _ImageFactory2.default(_extends({}, context, { renderCanvas: this.canvas, renderCanvasCtx: this.canvas.getContext("2d") }))),
                        (this.thumbnails = []);
                ...
                return (
                    ...
                    (Thumbnails.prototype.render = function () {
                        for (var elements = ['<div class="thumbnails">'], i = 0; i < this.size; ++i)
            ...
            View = (function () {
                function View(parentContainer, onLoad) {
                    ...
                    var script = template.html ? template.script : this.getTemplate().script,
                        urls = { styles: template.styles || this.getTemplate().styles, html: [template.html || this.getTemplate().html], script: script ? [script] : [] },
                        files = {},
                    ...
                    this.loadFiles(urls, files)
                        .then(function () {
                            ...
                            (_this3.stateSetters = [
                                { map: _this3.linkControls, setter: _this3.setLinkControlState.bind(_this3) },
                                { map: _this3.widgetControls, setter: _this3.setWidgetControlState.bind(_this3) },
                                { map: _this3.inputControls, setter: _this3.setInputControlState.bind(_this3) },
                                { map: _this3.textControls, setter: _this3.setTextControlState.bind(_this3) },
                            ]),
                                _this3.initView(),
            ...
            VisualWorld = (function (_THREE$EventDispatche) {
                function VisualWorld(wnd, doc, container) {
                    ...
                    (_this.wnd = wnd),
                        ...
                        (_this.camera = new _libs.THREE.PerspectiveCamera(30, _this.width() / _this.height(), 0.2, 2e3));
                    var scale = 1;
                    (_this.camera.position.x = 0),
                        (_this.camera.position.y = 5.5 * scale),
                        (_this.camera.position.z = 0),
                        (_this.renderer = new _libs.THREE.WebGLRenderer({ alpha: !0, antialias: !0 })),
                        ...
                        (0, _libs.$)(_this.cssRenderer.domElement).css({ position: "absolute", top: 0, margin: 0, padding: 0 }),
                    ...
                    _this.controls.addEventListener("change", function () {
                        ...
                        (_this.binds = { onWindowResize: _this.onWindowResize.bind(_this), animate: _this.animate.bind(_this) }),
                    ...
                    return (
                        (_this.mouseEvents.filter = function (element, e) {
                            ...
                            return (
                                "mousemove" === e.type && ((filterData.pageX = e.pageX), (filterData.pageY = e.pageY)),
                                e.relatedTarget && ~types.indexOf(e.type) && contains(element, e.target) && contains(element, e.relatedTarget) ? _extends({}, e, filterData) : e
                            );
                        }),
                ...
                return (
                    ...
                    (VisualWorld.prototype.createIndexedBufferGeometryFromGeometry = function (geometry) {
                        for (
                            var numVertices = geometry.vertices.length,
                                ...
                                indices = new (3 * numFaces > 65535 ? Uint32Array : Uint16Array)(3 * numFaces),
                                i = 0;
                            i < numVertices;
                            i++
                        ) {
                    ...
                    (VisualWorld.prototype.multyNodePositionCallback = function (node, p, n) {
                        for (
                            var geometry = this.geometry, volumePositions = geometry.attributes.position.array, volumeNormals = geometry.attributes.normal.array, assocVertex = geometry.mappedAssociation[node], k = 0;
        ...
        !(function (factory) {
            ...
            function handler(event) {
                ...
                if (
                    ...
                    "axis" in orgEvent && orgEvent.axis === orgEvent.HORIZONTAL_AXIS && ((deltaX = deltaY * -1), (deltaY = 0)),
                    (delta = 0 === deltaY ? deltaX : deltaY),
                    "deltaY" in orgEvent && ((deltaY = orgEvent.deltaY * -1), (delta = deltaY)),
                    "deltaX" in orgEvent && ((deltaX = orgEvent.deltaX), 0 === deltaY && (delta = deltaX * -1)),
                    0 !== deltaY || 0 !== deltaX)
                ) {
                    ...
                    if (
                        ...
                        (!lowestDelta || absDelta < lowestDelta) && ((lowestDelta = absDelta), shouldAdjustOldDeltas(orgEvent, absDelta) && (lowestDelta /= 40)),
